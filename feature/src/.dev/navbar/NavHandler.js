    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.feature.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.feature.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'feature'){
                    geotab.addin.feature.blur();
                } else {
                    geotab.addin.feature.focus(global.api, global.state);
                }
            }
        }, 100);
    }

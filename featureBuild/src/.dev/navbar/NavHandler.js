    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.featureBuild.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.featureBuild.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'featureBuild'){
                    geotab.addin.featureBuild.blur();
                } else {
                    geotab.addin.featureBuild.focus(global.api, global.state);
                }
            }
        }, 100);
    }
